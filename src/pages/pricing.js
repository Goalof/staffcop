...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="0px 0 0px 0" background="url(https://uploads.quarkly.io/5f844e532e3a2a001faf55b8/images/head-13.svg?v=2020-10-20T19:28:03.243Z) center -346px/3610px no-repeat">
			...
			<Section padding="70px 0 124px 0" lg-padding="70px 0 70px 0" font="600 18px/22px --fontFamily-googleInter" sm-padding="30px 0 30px 0">
		...
		<RawHtml>
			...
			<script place={"endOfBody"} rawKey={"6036a49c48f7383d1771b800"}>
