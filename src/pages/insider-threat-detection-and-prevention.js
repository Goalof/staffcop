			...
			<Stack margin="0px 0px 0px 0px">
				...
				<StackItem width="50%" display="flex" sm-align-items="center" sm-width="100%">
					...
					<Text
						...
						sm-text-align="center"
					>
						Protect Your Data and IP with Teramind's Insider Threat Monitoring, Detection and Prevention Solution{"\n\n"}
					</Text>
					{"    "}
					<Link
						href="/request-demo"
			...
			<Stack margin="0px 0px 0px 0px" width="100%">
				...
				<StackItem width="70%" display="flex" sm-width="100%" nout-width="100%">
					...
					<Text
						...
						sm-font="normal 700 24px/30px Inter, sans-serif"
					>
						Teramind: Detect, Prevent and Respond to Insider Threats with a Single Solution{"\n\n"}
					</Text>
					{"    "}
				</StackItem>
				{"    "}
			...
			<Stack margin="0px 0px 0px 0px">
				...
				>
					...
					>
						...
						>
							Teramind monitors all user activity covering 12+ system objects like: web, apps, email, file transfers, etc. and even on-screen content (OCR) in real-time.
						</Text>
					</Box>
					{"    "}
				</StackItem>
				...
				>
					...
					>
						...
						<Text
							...
							sm-font="normal 400 16px/140% Inter, sans-serif"
						>
							Discover and identify sensitive information and Teramind will protect them from falling into the wrong hands.
							<br />
							<br />
							<br />
							<br />
				...
				>
					...
					>
						...
						<Text
							...
							sm-font="normal 400 16px/140% Inter, sans-serif"
						>
							Use the powerful Policy & Rules Editor to create rules to define what constitutes insider threats. Teramind then takes immediate actions like warn, block, lockout user or take remote control of a system when rule violation is detected.
							<br />
							<br />
							<br />
							{"\n\n"}
				...
				>
					...
					>
						...
						<Text
							...
							sm-font="normal 400 16px/140% Inter, sans-serif"
						>
							Video recording of all user activity, audio recording, session recording, immutable logs, alerts and optional OCR search are just a few examples of Teramind’s powerful audit and forensic capabilities. Together they provide a vast collection of investigation data to locate the source and insider threat with pinpoint accuracy.{"\n\n"}
						</Text>
					</Box>
					{"    "}
				</StackItem>
				...
				>
					...
					>
						...
						<Text
							...
							sm-font="normal 400 16px/140% Inter, sans-serif"
						>
							Dynamic risk scoring and vulnerabilities scanning identifies insider threats before they become critical issues.
							<br />
							<br />
							{"\n"}
							<br />
				...
				>
					...
					>
						...
						<Text
							...
							sm-font="normal 400 16px/140% Inter, sans-serif"
						>
							onduct forensic investigation with incident reports, alerts and session recordings. Identify the source and cause of a security breach so that recovery plan can be formulated fast while preventing similar future incidents.
							<br />
							<br />
							<br />
							{"\n\n"}
			...
			>
				<StackItem width="50%" display="flex" md-width="100%" md-order="1">
					...
					<Text
						...
						sm-text-align="center"
					>
						Detailed alerts for all users can be viewed including any security incidents and what actions were taken. Warning messages can be configured to inform the users about nonconformity and influence corrective behavior. Instant snapshots, session recordings and history playback features can be used to view user’s desktop for audit and evidence gathering purposes..{"\n\n"}
					</Text>
					{"    "}
				</StackItem>
				<StackItem width="50%" display="flex" md-width="100%">
