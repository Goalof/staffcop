			...
			<Stack margin="0px 0px 0px 0px">
				...
				<StackItem width="50%" display="flex" md-width="100%">
					...
					<Components.Knopka
						...
						background="rgba(0, 0, 0, 0) url(https://uploads.quarkly.io/5f844e532e3a2a001faf55b8/images/charles-deluvio-pjAH2Ax4uWk-unsplash%201.png?v=2020-10-15T17:56:29.912Z) 0% 0% /cover no-repeat scroll padding-box"
						transition="-webkit-transition: all .3s;  transition: all .3s"
						border-radius="6px"
				...
				<StackItem width="50%" display="flex" md-width="100%">
					...
					<Components.Knopka
						...
						display="flex"
						flex-direction="column"
						background="rgba(0, 0, 0, 0) url(https://uploads.quarkly.io/5f844e532e3a2a001faf55b8/images/kaitlyn-baker-vZJdYl5JVXY-unsplash%201.png?v=2020-10-15T19:15:02.604Z) 0% 0% /cover no-repeat scroll padding-box"
						transition="-webkit-transition: all .3s;  transition: all .3s"
						border-radius="6px"
						lg-padding="68px 36px 30px 36px"
						sm-padding="38px 10px 30px 20px"
				...
				<StackItem width="50%" display="flex" md-width="100%">
					...
					<Components.Knopka
						...
						flex-direction="column"
						justify-content="center"
						background="rgba(0, 0, 0, 0) url(https://uploads.quarkly.io/5f844e532e3a2a001faf55b8/images/kaitlyn.png?v=2020-10-15T19:16:59.579Z) 0% 0% /cover no-repeat scroll padding-box"
						transition="-webkit-transition: all .3s;  transition: all .3s"
						border-radius="6px"
						lg-padding="68px 36px 30px 36px"
						sm-padding="38px 10px 30px 20px"
				...
				<StackItem width="50%" display="flex" md-width="100%">
					...
					<Components.Knopka
						...
						flex-direction="column"
						justify-content="center"
						background="rgba(0, 0, 0, 0) url(https://uploads.quarkly.io/5f844e532e3a2a001faf55b8/images/kaitlyn-baker-vZJdYl.png?v=2020-10-15T19:16:24.048Z) 0% 0% /cover no-repeat scroll padding-box"
						transition="-webkit-transition: all .3s;  transition: all .3s"
						border-radius="6px"
						lg-padding="68px 36px 30px 36px"
						sm-padding="38px 10px 30px 20px"
