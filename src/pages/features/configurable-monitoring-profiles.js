...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"features/configurable-monitoring-profiles"} />
		<Helmet>
			<title>
		...
		<Components.Header />
		<Section padding="180px 0 120px 0" background="url(https://uploads.quarkly.io/5f844e532e3a2a001faf55b8/images/head-13.svg?v=2020-10-20T19:28:03.243Z) center -896px/3610px no-repeat,linear-gradient(180deg,#F5F5F5 21.6%,rgba(251, 251, 251, 0.21) 100%)" lg-padding="60px 0 60px 0" md-padding="40px 0 40px 0">
				...
				>
					...
					<Box display="flex" align-items="center" margin="0px 0px 0px 0px">
						...
						<Text margin="9px 0px 9px 18px" color="#555" font="400 18px/160% --fontFamily-googleInter" sm-font="400 16px/22px --fontFamily-googleInter">
							Comply with monitoring regulations{"\n\n"}
						</Text>
					</Box>
					<Box display="flex" align-items="center">
						...
						/>
						<Text margin="9px 0px 9px 18px" color="#555" font="400 18px/160% --fontFamily-googleInter" sm-font="400 16px/22px --fontFamily-googleInter">
							Turn monitoring on/off based on activity{"\n\n"}
						</Text>
					</Box>
					<Box display="flex" align-items="center">
						<Icon
						...
						/>
						<Text margin="9px 0px 9px 18px" color="#555" font="400 18px/160% --fontFamily-googleInter" sm-font="400 16px/22px --fontFamily-googleInter">
							Customize when & what to monitor{"\n\n"}
						</Text>
					</Box>
					{"    "}
					<Link
			...
			<Stack margin="0px 0px 0px 0px" width="100%" gap="--cmp-stack-gap-default">
				...
				<StackItem width="80%" display="flex" sm-width="100%" nout-width="100%">
					...
					<Text
						...
						sm-text-align="center"
					>
						Teramind provides highly-granular, customizable monitoring profiles that allow you to define what actions to monitor, when to monitor, and who to monitor. Some use cases include:{"\n\n"}
					</Text>
					{"    "}
				</StackItem>
				<StackItem width="70%" display="flex" sm-width="100%" md-width="100%">
					...
					<Box display="flex" align-items="center" margin="0px 0px 18 0px">
						...
						<Text margin="9px 0px 9px 18px" font="400 18px/160% --fontFamily-googleInter" color="#555" sm-font="400 16px/22px --fontFamily-googleInter">
							Don't monitor users' screens when they are visiting their personal bank{"\n\n"}
						</Text>
					</Box>
					<Box display="flex" align-items="center" margin="0px 0px 18 0px">
						<Icon
						...
						/>
						<Text margin="9px 0px 9px 18px" font="400 18px/160% --fontFamily-googleInter" color="#555" sm-font="400 16px/22px --fontFamily-googleInter">
							Only monitor keystrokes when a user is in a sensitive application or website{"\n\n"}
						</Text>
					</Box>
					<Box display="flex" align-items="center" margin="0px 0px 18 0px">
						<Icon
						...
						/>
						<Text margin="9px 0px 9px 18px" font="400 18px/160% --fontFamily-googleInter" color="#555" sm-font="400 16px/22px --fontFamily-googleInter">
							Stop monitoring during lunch hour{"\n\n"}
						</Text>
					</Box>
					<Box display="flex" align-items="center" margin="0px 0px 18 0px">
						<Icon
						...
						/>
						<Text margin="9px 0px 9px 18px" font="400 18px/160% --fontFamily-googleInter" color="#555" sm-font="400 16px/22px --fontFamily-googleInter">
							Monitor e-mails only for a select group of employees{"\n\n"}
						</Text>
					</Box>
					<Box display="flex" align-items="center" margin="0px 0px 18 0px">
						<Icon
						...
						/>
						<Text margin="9px 0px 9px 18px" font="400 18px/160% --fontFamily-googleInter" color="#555" sm-font="400 16px/22px --fontFamily-googleInter">
							Define a custom record retention policy for groups or users{"\n\n"}
						</Text>
					</Box>
					{"            "}
				</StackItem>
